...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Element.prototype = {
	        ...
	        /**
	         * ZRender å®žä¾‹å¯¹è±¡ï¼Œä¼šåœ¨ element æ·»åŠ åˆ° zrender å®žä¾‹ä¸­åŽè‡ªåŠ¨èµ‹å€¼
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Animatable.prototype = {
	         ...
	         * åŠ¨ç”»
	         *
	         * @param {string} path éœ€è¦æ·»åŠ åŠ¨ç”»çš„å±žæ€§èŽ·å–è·¯å¾„ï¼Œå¯ä»¥é€šè¿‡a.b.cæ¥èŽ·å–æ·±å±‚çš„å±žæ€§
	         * @param {boolean} [loop] åŠ¨ç”»æ˜¯å¦å¾ªçŽ¯
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * å¯ä»¥ç”¨äºŽ isInsidePath åˆ¤æ–­ä»¥åŠèŽ·å–boundingRect
	 *
	 ...
	 // TODO getTotalLength, getPointAtLength
	    ...
	    PathProxy.prototype = {
	        ...
	        moveTo: function (x, y) {
	            ...
	            // æœ‰å¯èƒ½åœ¨ beginPath ä¹‹åŽç›´æŽ¥è°ƒç”¨ lineToï¼Œè¿™æ—¶å€™ x0, y0 éœ€è¦
	        ...
	        /**
	         * Context ä»Žå¤–éƒ¨ä¼ å…¥ï¼Œå› ä¸ºæœ‰å¯èƒ½æ˜¯ rebuildPath å®Œä¹‹åŽå† fillã€‚
	         * stroke åŒæ ·
	         * @param {CanvasRenderingContext2D} ctx
	         * @return {module:zrender/core/PathProxy}
	         */
	        ...
	        getBoundingRect: function () {
	            ...
	            for (var i = 0; i < data.length;) {
	                ...
	                if (i == 1) {
	                    ...
	                    //
	                    // ç¬¬ä¸€ä¸ªå‘½ä»¤ä¸º Arc çš„æƒ…å†µä¸‹ä¼šåœ¨åŽé¢ç‰¹æ®Šå¤„ç†
	                    xi = data[i];
	                    yi = data[i + 1];
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * è®¡ç®—ä¸‰æ¬¡è´å¡žå°”æ–¹ç¨‹æžé™å€¼çš„ä½ç½®
	     * @memberOf module:zrender/core/curve
	     * @param  {number} p0
	     * @param  {number} p1
	     * @param  {number} p2
	     ...
	     * æŠ•å°„ç‚¹æœ‰å¯èƒ½ä¼šæœ‰ä¸€ä¸ªæˆ–è€…å¤šä¸ªï¼Œè¿™é‡Œåªè¿”å›žå…¶ä¸­è·ç¦»æœ€çŸ­çš„ä¸€ä¸ªã€‚
	     * @param {number} x0
	     * @param {number} y0
	     * @param {number} x1
	     * @param {number} y1
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        /**
	         * äºŒæ¬¡è´å¡žå°”æ›²çº¿æè¾¹åŒ…å«åˆ¤æ–­
	         * @param  {number}  x0
	         * @param  {number}  y0
	         * @param  {number}  x1
	         * @param  {number}  y1
...
/***/ function(module, exports) {
	 ...
	 *
	 * @desc echartsåŸºäºŽCanvasï¼Œçº¯Javascriptå›¾è¡¨åº“ï¼Œæä¾›ç›´è§‚ï¼Œç”ŸåŠ¨ï¼Œå¯äº¤äº’ï¼Œå¯ä¸ªæ€§åŒ–å®šåˆ¶çš„æ•°æ®ç»Ÿè®¡å›¾è¡¨ã€‚
	 ...
	 */
	    ...
	    function detect(ua) {
	        ...
	        return {
	            ...
	            os: os,
	            node: false,
	            // åŽŸç”Ÿcanvasæ”¯æŒï¼Œæ”¹æžç«¯ç‚¹äº†
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param {boolean} isLoop
	     * @param {Array} constraint å°†è®¡ç®—å‡ºæ¥çš„æŽ§åˆ¶ç‚¹çº¦æŸåœ¨ä¸€ä¸ªåŒ…å›´ç›’å†…
	     *                           æ¯”å¦‚ [[0, 0], [100, 100]], è¿™ä¸ªåŒ…å›´ç›’ä¼šä¸Ž
	     *                           æ•´ä¸ªæŠ˜çº¿çš„åŒ…å›´ç›’åšä¸€ä¸ªå¹¶é›†ç”¨æ¥çº¦æŸæŽ§åˆ¶ç‚¹ã€‚
